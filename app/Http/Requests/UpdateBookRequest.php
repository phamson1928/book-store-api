...
class UpdateBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'weight_in_grams' => 'sometimes|required|integer',
            'packaging_size_cm' => 'sometimes|required|string',
            'number_of_pages' => 'sometimes|required|integer',
            'form' => 'sometimes|required|string',
            'state' => 'sometimes|required|in:Còn hàng,Hết hàng,Sắp có',
        ];
    }
